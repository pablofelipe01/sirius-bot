...
export const TEXTOS = {
  saludo:
    ...
    "Te hago 4 preguntas rápidas y te paso la información que le sirve para su cultivo. ¿Empezamos?",
  ...
  habeasData: (politicaUrl: string) =>
    "Al continuar, autoriza el tratamiento de sus datos para contactarlo con fines comerciales. " +
    `Puede pedir su eliminación cuando quiera escribiendo a este mismo chat. Política: ${politicaUrl}`,
  correo: "¿A qué correo te enviamos la información técnica?",
  correoIncompleto: "Creo que el correo quedó incompleto, ¿me lo confirma?",
  btnSinCorreo: "Prefiero no darlo",

  etapa: "¿Sobre cuál etapa quiere información?",
  etapaBotonLista: "Ver etapas",

  hectareas: "¿Cuántas hectáreas maneja?",
  ...
  cierre:
    "Un asesor te contacta esta semana para revisar su caso. Si quieres adelantar algo, escríbeme por acá cuando gustes.",
  ...
  asesor: "Lo conecto con un asesor. Te contacta pronto por este medio.",
